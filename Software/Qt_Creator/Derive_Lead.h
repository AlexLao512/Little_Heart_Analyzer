...
#ifndef DERIVE_LEAD_H
#define DERIVE_LEAD_H
...
private:
    ...
    bool negative;
public:
    Derive_Lead(double new_a_gain, double new_b_gain, bool new_subtract, bool new_negative);
    double derive(double a_input, double b_input);
};
